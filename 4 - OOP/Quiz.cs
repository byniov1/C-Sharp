...
class Quiz
{
    ...
    public void StartQuiz()
    {
        ...
        foreach(Question question in _questions)
        {
            ...
            {
                Console.WriteLine($"Wrong! The correct anwser was: {question.Answers[question.CorrectAnswerIndex]}");
            }
        }
    ...
    private void DisplayResult()
    {
        ...
        if(percentage >= 0.8)
        {
            ...
            System.Console.WriteLine("Excelent Work");
        }
        ...
        else
        {
            ...
            Console.WriteLine("Keep practicitng");
        }
        Console.ResetColor();   
    }
